...
def read_input():
	...
	for i in range(n):
		for letter in alphabet:
			train_data.append(flatten_image(imread("chars74k-lite/chars74k-lite/"+letter+"/"+letter+"_"+str(i)+".jpg")))
			train_solutions.append(letter)
	#
	m=88
	test_data=[]
	test_solutions=[]
	for i in range(n,m):
		for letter in alphabet:
			test_data.append(flatten_image(imread("chars74k-lite/chars74k-lite/"+letter+"/"+letter+"_"+str(i)+".jpg")))
			test_solutions.append(letter)
	#
